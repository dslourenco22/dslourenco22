...
* **Software Development:** Developing a Python application featuring real-time handwritten text recognition integrated with the Google Cloud Translation API.
* **Machine Learning:** Expanding technical knowledge in data science and AI applications within defensive cybersecurity.

### Core Skills & Languages
* **Technical Interests:** C++, Python, Cloud Security, Systems Development.
* **Languages:** Fluent in English and Portuguese; proficient in Spanish.
